...
import '../SignInWithGoogle/database.dart';
  ...
  Future<void> registration() async {
    ...
    if (emailController.text.isNotEmpty && nameController.text.isNotEmpty && passwordController.text.isNotEmpty) {
      try {
        ...
        // Create a new User object for Firestore
          app_user.User newUser = app_user.User(
          id: userCredential.user!.uid,
          name: nameController.text,
          email: userCredential.user!.email ?? '',
          avatarUrl: '', // No avatar provided in email signup
          bio: '',
          totalFollowers: 0,
          totalPosts: 0,
        ...
        Map<String, dynamic> userInfoMap = newUser.toMap();
