...
class BMaterialTheme {
  ...
  static MaterialScheme _lightScheme() {
    return const MaterialScheme(
      ...
      onSecondary: Color.fromARGB(255, 182, 182, 182),
      ...
      shadow: Color.fromARGB(255, 255, 1, 1),
